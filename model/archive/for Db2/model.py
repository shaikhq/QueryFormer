...
class FeatureEmbed(nn.Module):
    ...
    #     # TODO: the following code expects bin_number argument. Since I am not passing it, it seems to cause an dim mismatch error
    #     # temporarily I am going to remote this one
    ...
    #TODO: SQ - temporary workaround version of forward method:
    def forward(self, feature):
        # TODO: the following code expects bin_number argument. Since I am not passing it, it seems to cause an dim mismatch error
        # temporarily I am going to remote this one
        typeId, joinId, filtersId, filtersMask, hists, table_sample = torch.split(feature,(1,1,9,3,1001), dim = -1)
    ...
    def getFilter(self, filtersId, filtersMask):
        ...
        logging.info('getFilter: opsId {}'.format(opsId))
...
class QueryFormer(nn.Module):
    ...
    def forward(self, batched_data):
        ...
        #TODO: I am changing the dimension to 1015 since I have not added some of the features to each node, e.g., sample bitmap
        # original code:
        # x_view = x.view(-1, 1165)
        # new code:
        x_view = x.view(-1, 1015)
